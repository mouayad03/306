 ...
 */
 ...
 function onCustomerResponsed() {
   ...
   for (var i = 0; i < customerResponse .length; i++) {
     ...
     deleteButton.setAttribute("delete-customer-id", customerResponse[i].user_id);
     ...
     editButton.setAttribute("edit-customer-id", customerResponse[i].user_id);
 ...
 function onDeleteButtonPressed(event) {
   ...
   deleteRequest.open("Delete", "API/V1/Customer/" + event.currentTarget.getAttribute("delete-customer-id"));
 ...
 function onEditButtonPressed(event) {
   window.open("edit_customer.php#" + event.currentTarget.getAttribute("edit-customer-id"), "_self"); 
